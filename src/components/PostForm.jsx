...
const questions = [
  {
    question: "In the game, how did you identify Sarita was in distress?",
    options: [
  ...
  {
    question:
      "What was the first step taken as an HR manager when addressing Sarita's situation?",
    options: [
  ...
  {
    question:
      "During the interaction with Sarita, what approach ensured better communication?",
    options: [
  ...
  {
    question:
      "How did Rahul and Jatin, the bystanders, contribute to the resolution process?",
    options: [
      "A. They reported Sarita’s issues to the HR manager without her consent.",
      ...
      "D. They criticized Sarita for her lack of performance.",
    ],
    corrAns: 1,
  },
  {
    question:
      "What measure was taken to ensure Sarita’s privacy during the resolution?",
    options: [
  ...
  {
    question: "What follow-up action was taken to ensure Sarita’s well-being?",
    options: [
...
const PostForm = () => {
  ...
  return (
    <div className="mx-auto max-w-4xl bg-[#f8e5d0] p-6">
      <h1 className="mb-4 text-3xl font-semibold text-[#5A3D36]">
        Post Game Questions
      </h1>

      <form>
        {questions.map((question, index) => (
          <div key={index} className="mb-6 rounded-lg bg-white p-4 shadow-lg">
            ...
            <div className="space-y-2">
              {question.options.map((option, optionIndex) => (
                <label
                  key={optionIndex}
                  className="block cursor-pointer text-[#6B4F41] hover:text-[#9a6a5d]"
                >
                  <input
                    type="radio"
                    name={`question-${index}`}
